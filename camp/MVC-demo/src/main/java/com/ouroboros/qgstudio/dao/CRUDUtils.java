...
public class CRUDUtils {
     ...
     * @return 插入的结果
     */
    public static int insert(Connection conn, List<Object> params) {
        try(PreparedStatement ps = conn.prepareStatement("INSERT INTO user (username,password,sex,email) VALUES(?,?,?,?);")){
     ...
     * @return 删除的结果
     */
    public static int delete(Connection conn, String range, List<Object> params) {
     ...
     */
    public static List<Object> query(Connection conn,String range,List<Object> params){
